...
# $Id: 10_KNX.pm 29084 2024-08-19 18:55:08Z erwin $  
################################################################################
### changelog:
...
my $SVNID       = '$Id: 10_KNX.pm 29084 2024-08-19 18:55:08Z erwin $'; ## no critic (Policy::ValuesAndExpressions::RequireInterpolationOfMetachars)
...
sub KNX_Define2 {
	...
	foreach my $gaddef (@a) {
		...
		$gad = KNX_hex2Name($gad) if ($gad =~ m/^$PAT_GAD_HEX$/ixms);
		$gadCode = KNX_name2Hex ($gad); #convert it vice-versa, just to be sure
